...
2) replace MARRIAGE value 0 with 3 ('other' category) as there is not a 0 category for marriage column on datadescription 
...
# function for the preprocessing pipeline (split temporal and static features - 3d matrix of temporal features)    
...
######################### Results on test set - Optimal configurations for each experimental setup ##################################
